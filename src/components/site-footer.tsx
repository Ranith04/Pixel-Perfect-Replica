    ...
    <footer id="contact">
      <div className="container">
        <div className="footer-grid">
          <div>
            ...
            <p className="footer-brand-desc">
              Empowering local partners with technology to build trust-based neighborhood commerce
        ...
        <div className="footer-bottom">
          <div className="footer-copy">© 2024 MyCheckStore. All rights reserved.</div>
          <div className="footer-made">Made with ❤️ in India</div>
        </div>
      </div>
    </footer>
  );
